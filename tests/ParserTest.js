/**
 * This file is just used for on the fly testing and debugging ond not rly needed elsewhere.
 */

const ReleaseParser = require('../ReleaseParser.js')

console.log( '  [Parsed] ' + new ReleaseParser( '24.S02E02.9.00.Uhr.bis.10.00.Uhr.German.DL.TV.Dubbed.DVDRip.SVCD.READ.NFO-c0nFuSed', 'tv' ).toString() )
